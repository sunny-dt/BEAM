...
@Component({
  selector: 'app-core-data-facet',
  templateUrl: './core-data-facet.component.html',
  styleUrls: ['./core-data-facet.component.css']
})
export class CoreDataFacetComponent implements OnInit {

  constructor(public service : FacetService, 
    private notificationService : NotificationService,
    public dialogRef : MatDialogRef<CoreDataFacetComponent>) { }
