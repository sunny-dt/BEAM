...
export class BuilderPlatformsDataSource implements DataSource<Platform> {
    ...
    constructor(private platformsService: BuilderPlatformService, private dialogService : DialogService, private authorizationService : AuthorizationService) {
    ...
    loadPlatforms(filter:string, 
        ...
        this.platformsService.findPlatforms(filter,
            ...
            .subscribe(platforms => {
                console.log('dialog subscribe platforms ', platforms);
