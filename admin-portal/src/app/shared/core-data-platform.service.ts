...
export class CoreDataPlatformService {
  ...
  public form : FormGroup = new FormGroup({
    ...
    facets_count : new FormControl('', Validators.required),
    isFeed : new FormControl(''),
  ...
  populateForm(platform)
  {
    ...
    console.log('this.form.setValue(platform)', this.form.setValue(platform));
  }
  ...
  addNewPlatform(platform: any) {
    ...
    const bodyParams = {
      "name": platform.name,
      "facet_count": parseInt(platform.facets_count),
    ...
    return this.httpClient.post(this.serviceApiUrl + '/addNewMasterPlatform', bodyParams, { headers: Constants.HTTP_HEADERS });
}
...
getPlatforms(filter = '', sortOrder = 'asc', sortColumn='id',
    ...
    return this.httpClient.get(this.serviceApiUrl+'/getMasterPlatforms' , {
        ...
        map(res =>  { 
          console.log('getcoreDataPlatforms', res);
          let response = JSON.parse(JSON.stringify(res));

            this.totalPlatformsCount = response["items"].length; 
            return res["items"];
...
getCoreDataPlatforms ():  Observable<any> {

  return this.httpClient.get(this.serviceApiUrl+'/getMasterPlatformsNotInMapper' , {
      headers: Constants.HTTP_HEADERS,
