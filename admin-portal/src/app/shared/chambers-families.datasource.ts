...
import { ChamberFamiliesService } from './chambers-families.service';



export class ChambersFamilyDataSource implements DataSource<any> {
    ...
    constructor(private chamberFamiliesService: ChamberFamiliesService) {
