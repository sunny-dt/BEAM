...
@Component({
  selector: 'app-home-featured-form',
  templateUrl: './home-featured-form.component.html',
  styleUrls: ['./home-featured-form.component.css']
})
export class HomeFeaturedFormComponent implements OnInit {


  imageURL: string = "";
  showHomeFeaturedImage: boolean = false;
  ...
  constructor(public service : HomeFeaturedService, 
    private uploadService : UploadService,
    private notificationService : NotificationService,
    private iconRegistry: MatIconRegistry,
    private sanitizer: DomSanitizer,
    public dialogRef : MatDialogRef<HomeFeaturedFormComponent>) { }
    public saveAndAddNewTapped = false;
  
  
  ngOnInit() {

     this.loadHomeFeaturedImage();
  }

  loadHomeFeaturedImage()
  {
    this.showHomeFeaturedImage = false;
    ...
    setTimeout(()=>{  
      ...
      this.imageURL = this.service.form.get('image_link').value;
        ...
        if(this.imageURL)
        {
          ...
          this.showHomeFeaturedImage = true;
        }
        else
        {
          this.showHomeFeaturedImage = false;
  ...
  onSubmit()
  {
    if(this.service.form.valid)
    {
        ...
        {
          this.service.updateHomeFeatured(this.service.form.value).subscribe(response => {

            console.log("Response - update home-featured-form : ", response);
        ...
        {
          this.service.insertHomeFeatured(this.service.form.value).subscribe(response => {

            console.log("Response - add new home-featured-form : ", response);
